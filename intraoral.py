...
def download_models():
    ...
    gdown.download(model_link, model_file_name, quiet=True, use_cookies = True)
    gdown.download(filtering_model_link, filtering_model_file_name, quiet=True, use_cookies = True)
