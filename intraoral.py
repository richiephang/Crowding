...
@st.cache_resource
def download_models():
    model_link = 'https://drive.google.com/uc?id=1oykHjvq5vUjYTaIO___Hh0AzfFaG_jYM'
    filtering_model_link = 'https://drive.google.com/uc?id=1oUeFLTlj0gnGxXQkiDmZ0zD-eMQUi8Nv'
